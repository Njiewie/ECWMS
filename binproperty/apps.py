    ...
    try:
        ...
        if ls.objects.filter(openid__iexact='init_data').exists():
            if ls.objects.filter(openid__iexact='init_data').count() != 4:
                ...
                init_data = [
                    ls(id=1, openid='init_data', bin_property='Damage', creater='ECWMS'),
                    ls(id=2, openid='init_data', bin_property='Inspection', creater='ECWMS'),
                    ls(id=3, openid='init_data', bin_property='Normal', creater='ECWMS'),
                    ls(id=4, openid='init_data', bin_property='Holding', creater='ECWMS')
                ]
