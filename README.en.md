...
<h4>
  <a href="https://github.com/ECWMS/GreaterwMS/issues/new?template=bug_report.md&title=[BUG]">Report Bug</a>
</h4>
<h4>   
  <a href="https://github.com/ECWMS/ECWMS/issues/new?template=feature_request.md&title=[FR]">Request Feature</a>
</h4>
<h4>
  <a href="https://www.56yhz.com/zh/ecwms.html">中文文档</a>
</h4>
...
Clone Project
~~~shell
git clone https://github.com/ECWMS/ECWMS.git
~~~
...
or
daphne -b 0.0.0.0 -p 8008 ecwms.asgi:application # lan
~~~
...
ECWMS is supported by a companion mobile app which allows users access to run the business well.
...
## Show
<div align="left">
    <img src="static/img/ECWMS_en.png" alt="ECWMS home" width="" height="400" />
</div>
<div align="left">
    <img src="static/img/mobile_splash.jpg" alt="ECWMS splash" width="200" height="400" />
    <img src="static/img/mobile_dn_en.jpg" alt="ECWMS dn" width="200" height="400" />
    <img src="static/img/mobile_equ_en.jpg" alt="ECWMS goods" width="200" height="400" />
</div>
