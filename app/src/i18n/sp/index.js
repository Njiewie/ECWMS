...
export default {
  ...
  index: {
    ...
    webtitle: 'ECWMS: sistema de gestión de almacenes de código abierto',
    home: 'página delantera',
    title: 'ECWMS',
    title_tip: 'Página de inicio de ECWMS',
  ...
  notice: {
    ...
    version: {
      ...
      detail: 'Vaya al sitio web oficial de ECWMS, https://www.56yhz.com/, para descargar la última versión de la APLICACIÓN'
    },
